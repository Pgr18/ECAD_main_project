// Generated by SolidPython <Unknown> on 2025-10-27 20:26:34
$fa = 0.4; $fs = 0.4;
...
rotate(a = 0, v = [1, 0, 0]) {
	difference() {
			...
			difference() {
				linear_extrude(height = 1.3500000000) {
					offset(r = 1.0000000000) {
						import(file = "ECAD_main-stencil_3d_edge.dxf", origin = [0, 0]);
					}
				}
		...
		linear_extrude(center = true, height = 0.6000000000) {
			translate(v = [0, 0, 0]) {
				import(file = "ECAD_main-stencil_3d_bottom.dxf", origin = [0, 0]);
			}
		}
	}
}
